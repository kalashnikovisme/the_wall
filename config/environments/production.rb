...
Rails.application.configure do
  ...
  config.action_controller.asset_host = "https://#{ENV['DO_SPACES_BUCKET']}.#{ENV['DO_SPACES_REGION']}.digitaloceanspaces.com"
  ...
  # config.active_job.queue_name_prefix = "proper_mrsk_production"
